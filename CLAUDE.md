...
- `items.js` — the weapon/item catalog (~269 items; skill tool kits via `it.skill`; functioning
  consumables via `it.effect` — HP/KP/chakra/limb restores applied on Use).
